...
public class JavaFxComponentClassMetadataProvider implements IComponentClassMetadataProvider {
	...
	public Map<Class<?>, ComponentClassMetadata> getMetadata() {
		Map<Class<?>, ComponentClassMetadata> metadata = new HashMap<Class<?>, ComponentClassMetadata>();
		
        // Populate componentClassMap
        metadata.put(AccordionMetadata.getKlass(), AccordionMetadata);
        metadata.put(AmbientLightMetadata.getKlass(), AmbientLightMetadata);
        metadata.put(AnchorPaneMetadata.getKlass(), AnchorPaneMetadata);
        metadata.put(ArcMetadata.getKlass(), ArcMetadata);
        metadata.put(ArcToMetadata.getKlass(), ArcToMetadata);
        metadata.put(AreaChartMetadata.getKlass(), AreaChartMetadata);
        metadata.put(AxisMetadata.getKlass(), AxisMetadata);
        metadata.put(BarChartMetadata.getKlass(), BarChartMetadata);
        metadata.put(BorderPaneMetadata.getKlass(), BorderPaneMetadata);
        metadata.put(BoxMetadata.getKlass(), BoxMetadata);
        metadata.put(BubbleChartMetadata.getKlass(), BubbleChartMetadata);
        metadata.put(ButtonMetadata.getKlass(), ButtonMetadata);
        metadata.put(ButtonBarMetadata.getKlass(), ButtonBarMetadata);
        metadata.put(ButtonBaseMetadata.getKlass(), ButtonBaseMetadata);
        metadata.put(CameraMetadata.getKlass(), CameraMetadata);
        metadata.put(CanvasMetadata.getKlass(), CanvasMetadata);
        metadata.put(CategoryAxisMetadata.getKlass(), CategoryAxisMetadata);
        metadata.put(ChartMetadata.getKlass(), ChartMetadata);
        metadata.put(CheckBoxMetadata.getKlass(), CheckBoxMetadata);
        metadata.put(CheckMenuItemMetadata.getKlass(), CheckMenuItemMetadata);
        metadata.put(ChoiceBoxMetadata.getKlass(), ChoiceBoxMetadata);
        metadata.put(CircleMetadata.getKlass(), CircleMetadata);
        metadata.put(ClosePathMetadata.getKlass(), ClosePathMetadata);
        metadata.put(ColorPickerMetadata.getKlass(), ColorPickerMetadata);
        metadata.put(ColumnConstraintsMetadata.getKlass(), ColumnConstraintsMetadata);
        metadata.put(ComboBoxMetadata.getKlass(), ComboBoxMetadata);
        metadata.put(ComboBoxBaseMetadata.getKlass(), ComboBoxBaseMetadata);
        metadata.put(ContextMenuMetadata.getKlass(), ContextMenuMetadata);
        metadata.put(ControlMetadata.getKlass(), ControlMetadata);
        metadata.put(CubicCurveMetadata.getKlass(), CubicCurveMetadata);
        metadata.put(CubicCurveToMetadata.getKlass(), CubicCurveToMetadata);
        metadata.put(CustomMenuItemMetadata.getKlass(), CustomMenuItemMetadata);
        metadata.put(CylinderMetadata.getKlass(), CylinderMetadata);
        metadata.put(DatePickerMetadata.getKlass(), DatePickerMetadata);
        metadata.put(DialogPaneMetadata.getKlass(), DialogPaneMetadata);
        metadata.put(EllipseMetadata.getKlass(), EllipseMetadata);
        metadata.put(FlowPaneMetadata.getKlass(), FlowPaneMetadata);
        metadata.put(GridPaneMetadata.getKlass(), GridPaneMetadata);
        metadata.put(GroupMetadata.getKlass(), GroupMetadata);
        metadata.put(HBoxMetadata.getKlass(), HBoxMetadata);
        metadata.put(HLineToMetadata.getKlass(), HLineToMetadata);
        metadata.put(HTMLEditorMetadata.getKlass(), HTMLEditorMetadata);
        metadata.put(HyperlinkMetadata.getKlass(), HyperlinkMetadata);
        metadata.put(ImageViewMetadata.getKlass(), ImageViewMetadata);
        metadata.put(LabelMetadata.getKlass(), LabelMetadata);
        metadata.put(LabeledMetadata.getKlass(), LabeledMetadata);
        metadata.put(LightBaseMetadata.getKlass(), LightBaseMetadata);
        metadata.put(LineMetadata.getKlass(), LineMetadata);
        metadata.put(LineChartMetadata.getKlass(), LineChartMetadata);
        metadata.put(LineToMetadata.getKlass(), LineToMetadata);
        metadata.put(ListViewMetadata.getKlass(), ListViewMetadata);
        metadata.put(MediaViewMetadata.getKlass(), MediaViewMetadata);
        metadata.put(MenuMetadata.getKlass(), MenuMetadata);
        metadata.put(MenuBarMetadata.getKlass(), MenuBarMetadata);
        metadata.put(MenuButtonMetadata.getKlass(), MenuButtonMetadata);
        metadata.put(MenuItemMetadata.getKlass(), MenuItemMetadata);
        metadata.put(MeshViewMetadata.getKlass(), MeshViewMetadata);
        metadata.put(MoveToMetadata.getKlass(), MoveToMetadata);
        metadata.put(NodeMetadata.getKlass(), NodeMetadata);
        metadata.put(NumberAxisMetadata.getKlass(), NumberAxisMetadata);
        metadata.put(PaginationMetadata.getKlass(), PaginationMetadata);
        metadata.put(PaneMetadata.getKlass(), PaneMetadata);
        metadata.put(ParallelCameraMetadata.getKlass(), ParallelCameraMetadata);
        metadata.put(ParentMetadata.getKlass(), ParentMetadata);
        metadata.put(PasswordFieldMetadata.getKlass(), PasswordFieldMetadata);
        metadata.put(PathMetadata.getKlass(), PathMetadata);
        metadata.put(PathElementMetadata.getKlass(), PathElementMetadata);
        metadata.put(PerspectiveCameraMetadata.getKlass(), PerspectiveCameraMetadata);
        metadata.put(PieChartMetadata.getKlass(), PieChartMetadata);
        metadata.put(PointLightMetadata.getKlass(), PointLightMetadata);
        metadata.put(PolygonMetadata.getKlass(), PolygonMetadata);
        metadata.put(PolylineMetadata.getKlass(), PolylineMetadata);
        metadata.put(PopupControlMetadata.getKlass(), PopupControlMetadata);
        metadata.put(PopupWindowMetadata.getKlass(), PopupWindowMetadata);
        metadata.put(ProgressBarMetadata.getKlass(), ProgressBarMetadata);
        metadata.put(ProgressIndicatorMetadata.getKlass(), ProgressIndicatorMetadata);
        metadata.put(QuadCurveMetadata.getKlass(), QuadCurveMetadata);
        metadata.put(QuadCurveToMetadata.getKlass(), QuadCurveToMetadata);
        metadata.put(RadioButtonMetadata.getKlass(), RadioButtonMetadata);
        metadata.put(RadioMenuItemMetadata.getKlass(), RadioMenuItemMetadata);
        metadata.put(RectangleMetadata.getKlass(), RectangleMetadata);
        metadata.put(RegionMetadata.getKlass(), RegionMetadata);
        metadata.put(RowConstraintsMetadata.getKlass(), RowConstraintsMetadata);
        metadata.put(SVGPathMetadata.getKlass(), SVGPathMetadata);
        metadata.put(ScatterChartMetadata.getKlass(), ScatterChartMetadata);
        metadata.put(ScrollBarMetadata.getKlass(), ScrollBarMetadata);
        metadata.put(ScrollPaneMetadata.getKlass(), ScrollPaneMetadata);
        metadata.put(SeparatorMetadata.getKlass(), SeparatorMetadata);
        metadata.put(SeparatorMenuItemMetadata.getKlass(), SeparatorMenuItemMetadata);
        metadata.put(ShapeMetadata.getKlass(), ShapeMetadata);
        metadata.put(Shape3DMetadata.getKlass(), Shape3DMetadata);
        metadata.put(SliderMetadata.getKlass(), SliderMetadata);
        metadata.put(SphereMetadata.getKlass(), SphereMetadata);
        metadata.put(SpinnerMetadata.getKlass(), SpinnerMetadata);
        ...
        metadata.put(StackPaneMetadata.getKlass(), StackPaneMetadata);
        metadata.put(StackedAreaChartMetadata.getKlass(), StackedAreaChartMetadata);
        metadata.put(StackedBarChartMetadata.getKlass(), StackedBarChartMetadata);
        metadata.put(SubSceneMetadata.getKlass(), SubSceneMetadata);
        metadata.put(SwingNodeMetadata.getKlass(), SwingNodeMetadata);
        metadata.put(TabMetadata.getKlass(), TabMetadata);
        metadata.put(TabPaneMetadata.getKlass(), TabPaneMetadata);
        metadata.put(TableColumnMetadata.getKlass(), TableColumnMetadata);
        metadata.put(TableColumnBaseMetadata.getKlass(), TableColumnBaseMetadata);
        metadata.put(TableViewMetadata.getKlass(), TableViewMetadata);
        metadata.put(TextMetadata.getKlass(), TextMetadata);
        metadata.put(TextAreaMetadata.getKlass(), TextAreaMetadata);
        metadata.put(TextFieldMetadata.getKlass(), TextFieldMetadata);
        metadata.put(TextFlowMetadata.getKlass(), TextFlowMetadata);
        metadata.put(TextFormatterMetadata.getKlass(), TextFormatterMetadata);
        metadata.put(TextInputControlMetadata.getKlass(), TextInputControlMetadata);
        metadata.put(TilePaneMetadata.getKlass(), TilePaneMetadata);
        metadata.put(TitledPaneMetadata.getKlass(), TitledPaneMetadata);
        metadata.put(ToggleButtonMetadata.getKlass(), ToggleButtonMetadata);
        metadata.put(ToolBarMetadata.getKlass(), ToolBarMetadata);
        metadata.put(TooltipMetadata.getKlass(), TooltipMetadata);
        metadata.put(TreeTableColumnMetadata.getKlass(), TreeTableColumnMetadata);
        metadata.put(TreeTableViewMetadata.getKlass(), TreeTableViewMetadata);
        metadata.put(TreeViewMetadata.getKlass(), TreeViewMetadata);
        metadata.put(VBoxMetadata.getKlass(), VBoxMetadata);
        metadata.put(VLineToMetadata.getKlass(), VLineToMetadata);
        metadata.put(ValueAxisMetadata.getKlass(), ValueAxisMetadata);
        metadata.put(WebViewMetadata.getKlass(), WebViewMetadata);
        metadata.put(XYChartMetadata.getKlass(), XYChartMetadata);
        metadata.put(IncludeElementMetadata.getKlass(), IncludeElementMetadata);
